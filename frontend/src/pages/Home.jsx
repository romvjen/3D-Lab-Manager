...
function Home() {
  ...
  const quickAccessCards = [
    {
      title: 'Items',
      description: 'Search and browse lab equipment inventory. Filter by category, status, and location.',
    ...
    {
      title: '3D Map',
      description: 'Visualize lab layout and locate equipment in 3D space. Perfect for navigation.',
    ...
    {
      title: 'Scan',
      description: 'Use your camera to scan QR codes on equipment for instant access to details.',
  ...
  const changelog = [
    {
      ...
      items: [
        ...
        '3D map placeholder with integration points',
  ...
  return (
    <Box sx={{ py: 2 }}>
      ...
      >
        ...
        >
          Browse equipment, locate items, and report issues quickly in the Senior Design Engineering Lab.
        </Typography>
      </Box>
        ...
        >
          <CardContent sx={{ p: 3 }}>
            {changelog.map((release) => (
              <Box key={release.version} sx={{ mb: 3, '&:last-child': { mb: 0 } }}>
                <Box
                  sx={{
                    display: 'flex',
                    alignItems: 'center',
